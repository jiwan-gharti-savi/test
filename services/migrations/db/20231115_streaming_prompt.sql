...
CREATE TABLE prompt.execute_prompts (
    execute_prompt_id SERIAL PRIMARY KEY,
    project_id integer,
    section_type character varying(32),
    prompt_seq_id integer,
    messages jsonb,
    is_error character varying(32),
    time integer,
    ...
    section_history_id integer,
    is_fun boolean,
    model_name character varying(128),
    created_at timestamp with time zone,
    modified_at timestamp with time zone,
    response jsonb,
    repeat_seq_id integer
);

-- Indices -------------------------------------------------------

CREATE UNIQUE INDEX execute_prompts_uniq ON prompt.execute_prompts(project_id int4_ops,section_type text_ops,section_history_id int4_ops,prompt_seq_id int4_ops,repeat_seq_id int4_ops);
...
CREATE TABLE prompt.prompt_seq (
    prompt_seq_id SERIAL PRIMARY KEY,
    seq integer,
    prompt_id bigint,
...
(1, 'claims', 'V1', 'f', NULL, NULL, NULL),
(2, 'title', 'V1', 't', NULL, NULL, NULL),
(3, 'regenerate_claim', 'V1', 'f', NULL, NULL, NULL),
(4, 'background_description', 'V1', 't', NULL, NULL, NULL),
(5, 'abstract', 'V1', 't', NULL, NULL, NULL),
(6, 'summary', 'V1', 't', NULL, NULL, NULL),
(7, 'technical_field', 'V1', 't', NULL, NULL, NULL),
(8, 'claims_alternative_entities', 'V1', 't', NULL, NULL, NULL),
(9, 'flowchart_diagram', 'V1', 'f', NULL, NULL, NULL),
(10, 'flowchart_description', 'V1', 'f', NULL, NULL, NULL),
(11, 'block_diagram_description', 'V1', 'f', NULL, NULL, NULL),
(12, 'block_diagram', 'V1', 'f', NULL, NULL, NULL),
(13, 'prior_art_search_query', 'V1', 't', NULL, NULL, NULL),
(14, 'prior_art_similarity', 'V1', 't', NULL, NULL, NULL),
(15, 'claims', 'V2', 'f', NULL, NULL, NULL),
(16, 'flowchart_common', 'V2', 't', NULL, NULL, NULL),
(17, 'flowchart_diagram', 'V2', 't', NULL, NULL, NULL),
(18, 'flowchart_description', 'V2', 't', NULL, NULL, NULL),
(19, 'block_diagram_common', 'V2', 't', NULL, NULL, NULL),
(20, 'block_diagram_description', 'V2', 't', NULL, NULL, NULL),
(21, 'block_diagram', 'V2', 't', NULL, NULL, NULL),
(22, 'claims_prompt', 'V1', 't', NULL, NULL, NULL),
(23, 'title_prompt', 'V1', 't', NULL, NULL, NULL),
(24, 'abstract_prompt', 'V1', 't', NULL, NULL, NULL),
(25, 'background_Description_prompt', 'V1', 't', NULL, NULL, NULL),
(26, 'summary_prompt', 'V1', 't', NULL, NULL, NULL),
(27, 'technical_field_prompt', 'V1', 't', NULL, NULL, NULL),
(28, 'claims', 'v3', 't', NULL, NULL, NULL),
(29, 'regenerate_claim', 'v2', 't', NULL, NULL, NULL);

DELETE from prompt.prompt_seq;

INSERT INTO "prompt"."prompt_seq" ("prompt_seq_id", "seq", "prompt_id", "short_name", "role", "instructions", "inputs", "outputs", "created_at", "modified_at", "repeat", "is_stream", "fun_def") VALUES
...
(2, 2, 1, 'claims_input', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 3, 1, 'claims_output1', 'user', 'Generate the output only for the following steps: step 1, step 2, step 3, step 4, step 5, step 6, step 7, step 8, step 8.1', NULL, '{"project": ["entities", "specific_attributes", "entity_quantification", "entity_generalised", "entity_generalised_actions", "novelty", "necessary_features", "optional_features", "necessary_entity_action", "additional_entity_action", "generalised_entity_attributes"]}', NULL, NULL, NULL, 't', '{"type": "function", "function":{
...
Claims:', '{"template": ["claim_template"]}', NULL, NULL, NULL, NULL, NULL, ''),
(6, 5, 1, 'claims_gen_output2', 'user', 'Claims:', NULL, '{"project": ["claims"]}', NULL, NULL, NULL, 't', '{
...
(4) Avoid mention or discussion of prior art references in the background.```', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 2, 2, 'Title_input', 'user', 'The invention description is as follows: ```{{invention}}```', '{"project": ["invention"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 3, 2, 'Title_output', 'user', 'Title:', NULL, '{"project": ["title"]}', NULL, NULL, NULL, 't', '{"name": "generate_title", "parameters": {"type": "object", "properties": {"title": {"type": "string", "description": "generate the title"}}}}'),
...
Step 8: Co-relate all the entities from the claims from Step 3 with entities from text ####current invention#### from Step 5. This is basically reverse mapping claimed entities with specific entities given in the text ####current invention####. Output in this format: Claim type 1: Entity 1 - Entity from text , Entity 2 - Entity from text Claim type 2: Entity 1 - entity from text, Entity 2 - entity from text etc.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 2, 3, 'regenerate_claim_input', 'user', 'Current invention:\n####{{invention}}####\n\nClaims:\n####{{claims}}####', '{"project": ["invention", "claims"]}', '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Step 10: Ensure all the claims from input ####claims#### are rewritten as per Step 9. Do not print output for this step.', NULL, '{"project": ["regenerated_claim"]}', NULL, NULL, NULL, 't', '{
...
Step 9: Confirm if steps 6 and 7 are followed for the generated background in step 4. Do not print output for this step.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 2, 4, 'background_Description_system_input', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(17, 3, 4, 'background_Description_system_output', 'user', 'background_description:', NULL, '{"project": ["background_description"]}', NULL, NULL, NULL, 't', '{
...
(19, 2, 5, 'Abstract_input', 'user', '''The claims is as follows: ####{{claims}}####', '{"project": ["claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(20, 3, 5, 'Abstract_output', 'user', 'abstract:', NULL, '{"project": ["abstract"]}', NULL, NULL, NULL, 't', '{
...
Step 4: Step 4: Avoid profanities like “field of invention” etc. in the output of Step 3. Do not print output for this step. Output: ==technical_field==', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(25, 2, 7, 'technical_Field_input', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(26, 3, 7, 'technical_Field_output', 'user', 'technical_field:', NULL, '{"project": ["technical_field"]}', NULL, NULL, NULL, 't', '{
...
', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(28, 2, 8, 'claims_alternative_entities_input_output', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', '{"project": ["entity_alternatives"]}', NULL, NULL, NULL, NULL, '{
...
(30, 1, 9, 'flowchart_diagram', 'system', 'I have provided you mapping between entities from Claims and entities from text ####current invention#### in text  ####Generalised Entities####. Format for the mapping is: Claim 1: entity from claim - entity from text####current invention####
...
Step 7: Identify the decision making step from the output of step 6.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(31, 2, 9, 'flowchart_diagram', 'user', 'Current Invention: ####{{invention}}#### \n\n Generalized Entities: ####{{generalized_entities}}#### \n\n Entity Actions: ####{{entity_action}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "generalized_entities", "entity_action", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, ''),
(32, 3, 9, 'flowchart_diagram', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(33, 4, 9, 'flowchart_diagram', 'user', 'step 4:', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(34, 5, 9, 'flowchart_diagram', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(35, 6, 9, 'flowchart_diagram', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(36, 7, 9, 'flowchart_diagram', 'user', 'step 6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(37, 8, 9, 'flowchart_diagram', 'user', 'step 7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Print the output not the step.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(39, 10, 9, 'flowchart_diagram', 'user', 'step 20', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(40, 11, 9, 'flowchart_diagram', 'user', 'Step 22: Using output from step 20, generate one mermaid for all the steps, without the sub-steps, which together encompass the method in context of Step 6 and step 7. ', NULL, '{"project": ["mermaid"]}', NULL, NULL, NULL, 't', '{
...
(41, 12, 9, 'flowchart_diagram', 'user', 'Step 23: Using the output of step 22, identify the goal of the steps in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Brief Description;', NULL, '{"project": ["breif_description"]}', NULL, NULL, NULL, 't', '{
...
(44, 15, 9, 'flowchart_diagram', 'user', 'Step 26: Using the {mermaids} , identify the goal of the steps for each mermaid separately in fewer than 20 words. ', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Brief Description;', NULL, '{"project": ["breif_descriptions"]}', NULL, NULL, NULL, 't', '{
...
Step 16: Ensure all the entities from text ####generalised entities#### are co-related with all the steps and sub-steps from Step 6 in Step 15. Do not print output for this step. ', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(47, 2, 10, 'flowchart_description', 'user', 'Current Invention: ####{{invention}}#### \n\n Generalized Entities: ####{{generalized_entities}}#### \n\n Entity Actions: ####{{entity_action}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "generalized_entities", "entity_action", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(48, 3, 10, 'flowchart_description', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(49, 4, 10, 'flowchart_description', 'user', 'step 4', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(50, 5, 10, 'flowchart_description', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(51, 6, 10, 'flowchart_description', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(52, 7, 10, 'flowchart_description', 'user', 'step 6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(53, 8, 10, 'flowchart_description', 'user', 'step 7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(54, 9, 10, 'flowchart_description', 'user', 'step 10 and step 11', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(55, 10, 10, 'flowchart_description', 'user', 'step 14', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(56, 11, 10, 'flowchart_description', 'user', 'step 15 and step 16', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(57, 12, 10, 'flowchart_description', 'user', 'Step 17: Choose the most logical combination of alternatives for the entities from Step 16 in context of Step 14 and text ####claims####.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(58, 13, 10, 'flowchart_description', 'user', 'All main steps from step 6', NULL, '{"project": ["steps"]}', NULL, NULL, NULL, 'f', '{"name": "generate_all_step_titles", "parameters": {"type": "object", "properties": {"steps": {"type": "array", "items": {"type": "object", "properties": {"step_num": {"type": "number"}}}, "description": "generate all step number from output"}}}}'),
...
Step 16: Ensure all the entities from text ####generalized entities#### are co-related with steps from Step 5.7 in Step 15. Do not print output for this step.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(82, 2, 11, 'block_diagram_description', 'user', 'Current Invention: ####{{invention}}#### \n\n Generalized Entities: ####{{generalized_entities}}#### \n\n Entity Actions: ####{{entity_action}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "generalized_entities", "entity_action", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(83, 3, 11, 'block_diagram_description', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(84, 4, 11, 'block_diagram_description', 'user', 'step 4', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(85, 5, 11, 'block_diagram_description', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(86, 6, 11, 'block_diagram_description', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(87, 7, 11, 'block_diagram_description', 'user', 'step 5.2', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(88, 8, 11, 'block_diagram_description', 'user', 'step 5.3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(89, 9, 11, 'block_diagram_description', 'user', 'step 5.4 and step 5.5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(90, 10, 11, 'block_diagram_description', 'user', 'step 5.6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(91, 11, 11, 'block_diagram_description', 'user', 'step 5.7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(92, 12, 11, 'block_diagram_description', 'user', 'step 12 and step 13', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(93, 13, 11, 'block_diagram_description', 'user', 'step 14', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(94, 14, 11, 'block_diagram_description', 'user', 'step 15 and step 16', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(95, 15, 11, 'block_diagram_description', 'user', 'explain the overview of the system identified in step 2 in context of the text ####current invention####.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(98, 18, 11, 'block_diagram_description', 'user', 'System and all main components from step 5.7', NULL, '{"project": ["steps"]}', NULL, NULL, NULL, NULL, '{
...
Step 5.7: Number the system, component and sub-component from the output of step 5.2 and step 5.6, in an even numbering series with increment of 2 for each step, as follows - if the system is 200, the component number is 202 - it''s sub-component number will be 202-a, 202-b, for  component 204 the sub-component will be 204-a, 204-b etc.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(107, 2, 12, 'block_diagram', 'user', 'Current Invention: ####{{invention}}#### \n\n Generalized Entities: ####{{generalized_entities}}#### \n\n Entity Actions: ####{{entity_action}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "generalized_entities", "entity_action", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(108, 3, 12, 'block_diagram', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(109, 4, 12, 'block_diagram', 'user', 'step 4: ', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(110, 5, 12, 'block_diagram', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(111, 6, 12, 'block_diagram', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(112, 7, 12, 'block_diagram', 'user', 'step 5.2', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(113, 8, 12, 'block_diagram', 'user', 'step 5.3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(114, 9, 12, 'block_diagram', 'user', 'step 5.4 and step 5.5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(115, 10, 12, 'block_diagram', 'user', 'step 5.6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(116, 11, 12, 'block_diagram', 'user', 'step 5.7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Step 22: Ensure that a valid mermaid syntax has been generated in step 20. Do not print the output for this step. ', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(118, 13, 12, 'block_diagram', 'user', 'step 20', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(119, 14, 12, 'block_diagram', 'user', 'Step 26: Using output from step 20, generate one mermaid for all the main components, without the sub-components, which together enable/manifest all the entity actions from all the system/apparatus/device/machine/product claims  in context of Step 5.7.', NULL, '{"project": ["mermaid"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_mermaid",
    "parameters": {
        "type": "object",
        "properties": {
...
(120, 15, 12, 'block_diagram', 'user', 'Step 27: Using the output of step 26, identify the goal of the steps in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
(123, 18, 12, 'block_diagram', 'user', ' Step 30: Using the output of step 29, identify the goal of the steps for each mermaid separately in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Step 7: Rewrite the {necessary_features} using the generalised language of entities from {entity_generalised} and all it''s respective entity attributes from {entity_attributes} associated with the generalised entities. Output format ==necessary_features_generalised==', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(131, 2, 15, 'claims', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(132, 3, 15, 'claims', 'user', 'Generate the output only for the following steps: step 1, step 2, step 4, step 4.1, Step 4.2, step 5, step 6, Step 7', NULL, '{"project": []}', NULL, NULL, NULL, 't', ''),
...
Independent Claims:', '{"template": ["claim_template"]}', '{"project": ["independent_claims"]}', NULL, NULL, NULL, 't', '{
...
All {independent_claims} and Step 40 output:', NULL, '{"project": ["claims"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_claims",
    "parameters": {
        "type": "object",
        "properties": {
...
(137, 1, 16, 'flowchart_common', 'system', 'I have provided you mapping between entities from Claims and entities from text ####current invention#### in text  ####Generalised Entities####. Format for the mapping is: Claim 1: entity from claim - entity from text####current invention####
...
Step 7: Identify the decision making step from the output of step 6.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(138, 2, 16, 'flowchart_common', 'user', 'Current Invention: ####{{invention}}#### \n\n entity_generalized_rewritten: ####{{entity_generalized_rewritten}}#### \n\n entity_actions_rewritten: ####{{entity_actions_rewritten}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "entity_generalized_rewritten", "entity_actions_rewritten", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(139, 3, 16, 'flowchart_common', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(140, 4, 16, 'flowchart_common', 'user', 'step 4:', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(141, 5, 16, 'flowchart_common', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(142, 6, 16, 'flowchart_common', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(143, 7, 16, 'flowchart_common', 'user', 'step 6', NULL, '{"project": ["flowchart_common"]}', NULL, NULL, NULL, NULL, NULL),
(144, 8, 17, 'flowchart_diagram', 'user', 'step 7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Step 20:  Confirm that the the yes and no condition from the decision making step from step 7 has already been considered in the output of Step 19. If no, then re-generate the output from Step 19. Do not print output for this step.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(146, 10, 17, 'flowchart_diagram', 'user', 'step 19, step 20', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(147, 11, 17, 'flowchart_diagram', 'user', 'Step 22: Using output from step 19, generate one mermaid for all the steps, without the sub-steps, which together encompass the method in context of Step 6 and step 7. 
...
110 -- Yes --> 112
112 --> 114
110 -- No --> 102', NULL, '{"project": ["mermaid"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_mermaid",
    "parameters": {
        "type": "object",
        "properties": {
...
(148, 12, 17, 'flowchart_diagram', 'user', 'Step 23: Using the output of step 22, identify the goal of the steps in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
110 -- Yes --> 112
112 --> 114
110 -- No --> 102', NULL, '{"project": ["mermaids"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_multiple_mermaid",
    "parameters": {
        "type": "object",
        "properties": {
...
(151, 15, 17, 'flowchart_diagram', 'user', 'Step 26: Using the {mermaids} , identify the goal of the steps for each mermaid separately in fewer than 20 words. ', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
(154, 8, 18, 'flowchart_description', 'user', 'All main steps numbers from Step 6', NULL, '{"project": ["steps"]}', NULL, NULL, NULL, 'f', '{"name": "generate_all_step_titles", "parameters": {"type": "object", "properties": {"steps": {"type": "array", "items": {"type": "object", "properties": {"step_num": {"type": "number"}}}, "description": "generate all step number from output"}}}}'),
...
Step 16: Ensure all the entities from text ####entity_generalized_rewritten #### are co-related with all the steps and sub-steps from Step 6 in Step 15. Do not print output for this step.  Step 10 and Step 11:', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(156, 10, 18, 'flowchart_description', 'user', 'step 14', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(157, 11, 18, 'flowchart_description', 'user', 'step 15 and step 16', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(158, 12, 18, 'flowchart_description', 'user', 'Step 17: Choose the most logical combination of alternatives for the entities from Step 16 in context of Step 14 and text ####claims####.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(159, 14, 18, 'flowchart_description', 'user', 'Choose the step {{step_num}} and its sub-steps (if any) from Step 6 for the explanation. Define all the entity actions for all the steps and sub-steps. The definitions must include what the entity actions are in the real world, the entities involved, what do the entities do and why do they do what they do. The definition goal is to 
explain how all the entity actions are manifested/practiced by the chosen step and it’s sub-steps from the output of Step 10.  In this explanation, include all the details/definitions/parameters/mechanism/structure/working/properties/mathematical construct/metrics/measurements/other forms of all the entities and all the entity actions manifested/practiced by the chosen step and it’s sub-steps from the output of Step 10.  Include implicit entities/steps/working/components/parts/conditions/ranges that will explain all the entity actions of/by/on the entities involved for the chosen step and sub-step only so that a technical expert can understand the entity actions of all entities in the chosen step and sub-step without having to make any assumptions.  Write the explanation of the chosen step and sub-step only. For the chosen step and sub-step, explain in detail all the entities and all the entity actions from step 10 in a paragraph format by referencing the step numbers from Step 6. Write the explanation in about 250 words for the chosen step it’s sub-step. Do not refer to the alternatives  for all the entities for the chosen step from the output of Step 14 for this explanation. ', '{"project": ["flowchart_main_element_nums"]}', '{"project": []}', NULL, NULL, 'Start', NULL, NULL),
(160, 15, 18, 'flowchart_description', 'user', 'Revise the explanation by removing the adjectives/superlatives for all the entities and their actions. Avoid patent profanity terms like "invention", "entity", "entities", "alternative of each entity", "layman", "implicit component", "technical write-up" and "entity action", "real-world" etc. Also, please avoid use of superlatives like "critical", "most important", "crucial", "important" etc. Our goal is only to state facts about the entities involved in the step, it''s working, it''s real world manifestation and not use any adjectives/language that deviates from that goal.', NULL, '{"project": ["flowchart_description"]}', NULL, NULL, 'End', 't', NULL),
(166, 12, 20, 'block_diagram_description', 'user', 'System and all main components from step 5.7', NULL, '{"project": ["steps"]}', NULL, NULL, NULL, NULL, '{
    "name": "generate_all_step_titles",
    "parameters": {
        "type": "object",
        "properties": {
...
Step 16: Ensure all the entities from text #### entity_generalized_rewritten#### are co-related with steps from Step 5.8 in Step 15. Do not print output for this step.  Output of Step 12 and Step 13:', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(169, 15, 20, 'block_diagram_description', 'user', 'step 14', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(170, 16, 20, 'block_diagram_description', 'user', 'step 15 and step 16', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
Number all the components and sub-components from Step 5.8 in the explanation. Do not refer to the words like "entity", "entities", "claim", "crucial" etc. in the explanation. Do not use titles like "Introduction" and "component and sub-component overview" etc. in the output. Write the output in a paragraph format to improve user readability. ', '{"project": ["flowchart_main_element_nums"]}', '{"project": []}', NULL, NULL, 'Start', NULL, NULL),
...
Do not repeat anything from the explanation that explains the entities comprising the component and sub-component from above. Do not use titles like Introduction and working of component and sub-component in the output. Format the entire explanation in a paragraph format for good readability.', '{"project": ["flowchart_main_element_nums"]}', '{"project": []}', NULL, NULL, '', NULL, NULL),
(174, 20, 20, 'block_diagram_description', 'user', 'Combine the introduction and explanation of {{step_num}} and its sub-components. Revise by removing the adjectives/superlatives for all the entities and their actions. Remove patent profanity terms  like "invention", "entity", "entities", "alternative of each entity", "laymen", "implicit component", "technical write-up" and "entity action", "real-world" etc. Also, remove superlatives like "critical", "most important", "crucial", "important"etc. Our goal is only to state facts about the component/sub-component and it''s working, it''s real world manifestation and not use any adjectives/language that deviates from that goal.', '{"project": ["flowchart_main_element_nums"]}', '{"project": ["block_diagram_description"]}', NULL, NULL, 'End', 't', NULL),
...
Step 5.7: Number the system, component and sub-component from the output of step 5.2 and step 5.6, in an even numbering series with increment of 2 for each step, as follows - if the system is 200, the component number is 202 - it''s sub-component number will be 202-a, 202-b, for  component 204 the sub-component will be 204-a, 204-b etc.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(177, 2, 19, 'block_diagram_common', 'user', 'Current Invention: ####{{invention}}#### \n\n entity_actions_rewritten: ####{{entity_actions_rewritten}}#### \n\n entity_generalized_rewritten: ####{{entity_generalized_rewritten}}#### \n\n Claims: ####{{claims}}#### alternatives for each entity ####{{alternative_entity_name}}####', '{"project": ["invention", "entity_actions_rewritten", "entity_actions_rewritten", "alternative_entity_name", "claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(178, 3, 19, 'block_diagram_common', 'user', 'step 3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(179, 4, 19, 'block_diagram_common', 'user', 'step 4', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(180, 5, 19, 'block_diagram_common', 'user', 'step 5', NULL, '{"project": ["block_diagram_common"]}', NULL, NULL, NULL, NULL, NULL),
(181, 6, 19, 'block_diagram_common', 'user', 'step 5.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(182, 7, 19, 'block_diagram_common', 'user', 'step 5.2', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(183, 8, 19, 'block_diagram_common', 'user', 'step 5.3', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(184, 9, 19, 'block_diagram_common', 'user', 'step 5.4 and step 5.5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(185, 10, 19, 'block_diagram_common', 'user', 'step 5.6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(186, 11, 19, 'block_diagram_common', 'user', 'step 5.7', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(187, 12, 21, 'block_diagram', 'user', 'Step 16: Provide the mermaid script/syntax for step 5.7 by considering the following: 
For the mermaid script/syntax, understand the output of step 5.7 in context of step 5.4. Step 5.4 identifies how the components interact with each other and  groups them into main components and sub-components. Do not print output for this step.
...
Step 22: Ensure that a valid mermaid syntax has been generated in step 20. Do not print the output for this step. ', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(188, 13, 21, 'block_diagram', 'user', 'Step 20, Step 22', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(189, 14, 21, 'block_diagram', 'user', 'Step 26: Using output from step 20, generate one mermaid for all the main components, without the sub-components, which together enable/manifest all the entity actions from all the system/apparatus/device/machine/product claims  in context of Step 5.7.
...
200 --- 204
204 --- 206', NULL, '{"project": ["mermaid"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_mermaid",
    "parameters": {
        "type": "object",
        "properties": {
...
(190, 15, 21, 'block_diagram', 'user', 'Step 27: Using the output of step 26, identify the goal of the steps in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
...
200 --- 204
204 --- 206', NULL, '{"project": ["mermaids"]}', NULL, NULL, NULL, 't', '{
    "name": "generate_multiple_mermaid",
    "parameters": {
        "type": "object",
        "properties": {
...
(193, 18, 21, 'block_diagram', 'user', 'Step 30: Using the output of step 29, identify the goal of the steps for each mermaid separately in fewer than 20 words.', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(194, 19, 21, 'block_diagram', 'user', 'Step 31: The output of step 30 is for a flow chart named as figure 2A, 2B, 2C and so on. Generate a brief description of each figure in 1 line. Consider the writing style of sample given below:
...
(195, 3, 22, 'claims_prompt', 'user', 'Modified Claims:', NULL, '{"project": ["claims"]}', NULL, NULL, NULL, 't', '{
...
(196, 1, 22, 'claims_prompt', 'system', 'Perform all the steps from Step 1 to Step 9. Generate the modified claims without #### and new line with \n.
    ...
    Step 9 - Finalise the claims with the adjusted style and ensure that the numbering and dependencies are correct. Do not print output for this step', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(197, 2, 22, 'claims_prompt', 'user', 'claims: ####{{claims}}#### attorney instructions: ####{{prompt_instructions}}####', '{"params": ["prompt_instructions"], "project": ["claims"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(198, 3, 23, 'title_prompt', 'user', 'Modified title:', '{"params": []}', '{"project": ["title"]}', NULL, NULL, NULL, 't', '{
...
(203, 2, 24, 'abstract_prompt', 'user', 'abstract: ####{{abstract}}####', '{"project": ["abstract"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(204, 3, 25, 'background_Description_prompt', 'user', 'attorney instructions: ####{{prompt_instructions}}####
Modified background description:', '{"params": ["prompt_instructions"]}', '{"project": ["background_description"]}', NULL, NULL, NULL, 't', '{
...
(205, 1, 25, 'background_Description_prompt', 'system', 'You are playing the role of a technical assistant. The only inputs you will accept from the user are background description and attorney instructions are delimited by ####. It is crucial that you follow the attorney instructions provided and avoid using any prohibited words or phrases. don''t include explanation or introduction Please give more importance to attorney instructions and do not repeat them in the output. Thank you for your attention to detail and adherence to the guidelines.', '{"params": ["modifed_section_type"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(206, 2, 25, 'background_Description_prompt', 'user', 'background_description: ####{{background_description}}####', '{"params": ["modifed_section_type"], "project": ["background_description"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(207, 3, 26, 'summary_prompt', 'user', 'attorney instructions: ####{{prompt_instructions}}####
Modified summary:', '{"params": ["prompt_instructions"]}', '{"project": ["summary"]}', NULL, NULL, NULL, 't', '{
...
(208, 1, 26, 'summary_prompt', 'system', 'You are playing the role of a technical assistant. The only inputs you will accept from the user are summary and attorney instructions are delimited by ####. It is crucial that you follow the attorney instructions provided and avoid using any prohibited words or phrases. don''t include explanation or introduction Please give more importance to attorney instructions and do not repeat them in the output. Thank you for your attention to detail and adherence to the guidelines.', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(209, 2, 26, 'summary_prompt', 'user', 'summary: ####{{summary}}####', '{"project": ["summary"]}', NULL, NULL, NULL, NULL, NULL, NULL),
(210, 1, 27, 'technical_field_prompt', 'system', 'You are playing the role of a technical assistant. The only inputs you will accept from the user are technical field and attorney instructions are delimited by ####. It is crucial that you follow the attorney instructions provided and avoid using any prohibited words or phrases. don''t include explanation or introduction Please give more importance to attorney instructions and do not repeat them in the output. Thank you for your attention to detail and adherence to the guidelines.', NULL, NULL, NULL, NULL, NULL, 't', NULL),
(211, 3, 27, 'technical_field_prompt', 'user', 'attorney instructions: ####{{prompt_instructions}}####
Modified technical_field:', '{"params": ["prompt_instructions"]}', '{"project": ["technical_field"]}', NULL, NULL, NULL, NULL, '{
...
(212, 2, 27, 'technical_field_prompt', 'user', 'technical_field: ####{{technical_field}}####', '{"project": ["technical_field"]}', NULL, NULL, NULL, NULL, NULL, NULL),
...
(214, 2, 28, 'claims', 'user', 'current invention: ####{{invention}}####', '{"project": ["invention"]}', '{"project": ["entities", "specific_attributes", "entities_with_sequence", "entities_without_sequence", "entity_generalised", "entity_generalised_sequence", "entity_attributes", "entity_generalised_actions", "novelty", "necessary_features", "optional_features"]}', NULL, NULL, NULL, NULL, '{
    "name": "extract_intermediate_results",
    "parameters": {
        "type": "object",
        "properties": {
...
Independent Claims:', '{"template": ["claim_template"]}', '{"project": ["independent_claims"]}', NULL, NULL, NULL, NULL, '{
    "name": "generate_independent_claims",
    "description": "generate all independent claims. Each independent claim ends with double new lines",
    "parameters": {
        "type": "object",
...
Step 9: Make json with following fields, total_method_claims: total claims from step 1 and total_system_claims: total claims from Step 1', NULL, NULL, NULL, NULL, NULL, NULL, ''),
(219, 2, 29, 'regenerate_claim', 'user', 'current invention: ####{{invention}}#### Claims:\n####{{claims}}####', '{"project": ["invention", "claims"]}', NULL, NULL, NULL, NULL, NULL, ''),
(220, 3, 29, 'regenerate_claim', 'user', 'step 2', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(221, 4, 29, 'regenerate_claim', 'user', 'step 3 and step 3.1', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(222, 5, 29, 'regenerate_claim', 'user', 'step 4', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(223, 6, 29, 'regenerate_claim', 'user', 'step 5', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(224, 7, 29, 'regenerate_claim', 'user', 'step 6', NULL, '{"project": []}', NULL, NULL, NULL, NULL, NULL),
(225, 8, 29, 'regenerate_claim', 'user', 'step 7', NULL, '{"project": ["entity_actions_rewritten"]}', NULL, NULL, NULL, NULL, ''),
(226, 9, 29, 'regenerate_claim', 'user', 'step 8', NULL, '{"project": ["entity_generalized_rewritten"]}', NULL, NULL, NULL, NULL, ''),
(227, 10, 29, 'regenerate_claim', 'user', 'convert step 2 as json', NULL, '{"project": ["claim_stats"]}', NULL, NULL, NULL, NULL, '{
...
DELETE from prompt.templates;

INSERT INTO "prompt"."templates" ("template_id", "name", "value") VALUES
(1, 'claim_template', '1. A computer-implemented method, comprising:
...
ADD COLUMN mermaids jsonb;

ALTER TABLE project.figures_section_history
ADD COLUMN breif_descriptions jsonb;

ALTER TABLE project.figures_section_history
ADD COLUMN flowchart_main_element_nums jsonb;

-- ALTER TABLE project.sections ADD COLUMN section_history_id int4;

ALTER TABLE project.figures_section_history
ADD COLUMN is_dd_error text;

ALTER TABLE "project"."sections" ALTER COLUMN "prompt" SET DATA TYPE text;

-- ALTER TABLE "project"."sections"
-- ADD COLUMN "claim_section_history_id" int4;

-- ALTER TABLE "project"."sections"
-- ADD COLUMN "regenerate_claim_section_history_id" int4;

ALTER TABLE "project"."section_history"
ADD COLUMN "claim_stats" jsonb;


UPDATE project.sections
SET section_history_id = sh.section_history_id
FROM project.section_history sh
WHERE sections.project_id = sh.project_id
  AND sections.section_type = sh.section_type
  AND sh.is_selected = True;


UPDATE project.sections
SET section_history_id = sh.section_history_id
FROM project.figures_section_history sh
WHERE sections.project_id = sh.project_id
  AND sections.section_type = sh.section_type
  AND sh.is_selected = True;

UPDATE project.figures_section_history
SET is_dd_error = is_error;


UPDATE project.figures_section_history
SET mermaids = '[]', breif_descriptions = '[]', is_dd_error = 'Success'
FROM project.figures_section_history sh
WHERE project.figures_section_history.section_history_id = sh.section_history_id
  AND project.figures_section_history.is_error = 'Success'
  AND (project.figures_section_history.breif_descriptions is NULL 
  OR project.figures_section_history.mermaids is NULL);


ALTER TABLE "project"."section_history"
ADD COLUMN "specific_attributes" text,
ADD COLUMN "entities_with_sequence" text,
ADD COLUMN "entities_without_sequence" text,
ADD COLUMN "entity_generalised_sequence" text,
ADD COLUMN "entity_attributes" text,
ADD COLUMN "necessary_features_generalised" text,
ADD COLUMN "entity_actions_rewritten" text,
ADD COLUMN "entity_generalized_rewritten" text;

ALTER TABLE "project"."section_history"
ADD COLUMN "response_step3" text;

ALTER TABLE "reports"."openai_activity"
ADD COLUMN "seq" int4,
ADD COLUMN "llm_id" varchar(256),
ADD COLUMN "prompt_seq_id" int4,
ADD COLUMN "prompt_cost" float8,
ADD COLUMN "completion_cost" float8,
ADD COLUMN "total_cost" float8;

ALTER TABLE "reports"."activity"
ADD COLUMN "is_retry" varchar(32);